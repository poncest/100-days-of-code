...
**Progress:** Worked from "Center an Element Horizontally Using the margin Property" through the "Adjust the Hue of a Color" session.
...
**Progress:** Worked from "Adjust the Tone of a Color" through the "Use the CSS Transform scale Property to Change the Size of an Element" session.
