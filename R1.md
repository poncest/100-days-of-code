...
**Progress:** tarted the“Applied Visual Design” course. Worked from "Create Visual Balance Using the text-align Property" through the "Use the u Tag to Underline Text" session.
